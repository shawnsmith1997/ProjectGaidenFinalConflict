...
//====================
case 0:
    CreateBattleDialogueBasic(WordWrap(string(Attacker.Character.Name) +' unleashed a massive burst of energy!^@ ',200,'#',false), self.id);
...
//Fire Blast
//==========
case 20://after attack animation (not currently called but can be made to play sound ect)
    State = 40;//brief delay animation
...
case 30:
    State = 40;//post delay
    alarm[0] = 120;//2 second pause
    break;
//==========
//Post Delay
//==========
case 40:
    State = 50;//Deal Damage
    if(TestForPan()){
        PanBattleCutscene();
    }
    else{
...
//================    
case 90:
    //Attacker.Character.Countdown = Attacker.Character.MaxCountdown;//countdown
