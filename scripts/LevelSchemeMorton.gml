...
if (Character.Level = 5 and global.Promoted[14] = 1){
Character.Spells[4] = 'Attack'; //Morton Learns Attack
Character.SpellLevel[4] = 1; //Morton Learns Attack Level 1
Message += string(' ^#Morton learned Attack');
}

if (Character.Level = 9 and global.Promoted[14] = 1){
Character.SpellLevel[4] = 2; 
Message += string(' ^#Attack is now Level 2');
}

if (Character.Level = 11 and global.Promoted[14] = 1){
Character.SpellLevel[3] = 2; 
Message += string(' ^#Quick is now Level 2');
}
...
if (Character.Level = 15 and global.Promoted[14] = 1){
...
if (Character.Level = 13 and global.Promoted[14] = 1){
Character.SpellLevel[2] = 3; 
Message += string(' ^#Blast is now Level 3');
}

if (Character.Level = 17 and global.Promoted[14] = 1){
