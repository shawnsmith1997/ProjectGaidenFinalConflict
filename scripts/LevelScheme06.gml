...
if (Character.Level = 5 and global.Promoted[6] = 0){
Character.SpellLevel[1] = 2; 
Message += string(' ^#Heal is now Level 2');
}

if (Character.Level = 6 and global.Promoted[6] = 1){
Character.Spells[4] = 'Aura'; 
Character.SpellLevel[4] = 1; 
Message += string(' ^#Cynthia learned Aura');
}

if (Character.Level = 6 and global.Promoted[6] = 0){
Character.Spells[3] = 'Detox'; 
Character.SpellLevel[3] = 1; 
Message += string(' ^#Cynthia learned Detox');
}

if (Character.Level = 2 and global.Promoted[6] = 1){
Character.SpellLevel[3] = 2; 
Message += string(' ^#Detox is now Level 2');
}

if (Character.Level = 7 and global.Promoted[6] = 1){
Character.SpellLevel[1] = 3; 
Message += string(' ^#Heal is now Level 3');
}

if (Character.Level = 15 and global.Promoted[6] = 1){
...
if (Character.Level = 12 and global.Promoted[6] = 1){
Character.SpellLevel[2] = 4; 
Message += string(' ^#Blast is now Level 4');
}

if (Character.Level = 10 and global.Promoted[6] = 1){
Character.SpellLevel[4] = 2; 
Message += string(' ^#Aura is now Level 2');
}

if (Character.Level = 16 and global.Promoted[6] = 1){
Character.SpellLevel[4] = 3; 
Message += string(' ^#Aura is now Level 3');
}

if (Character.Level = 20 and global.Promoted[6] = 1){
Character.SpellLevel[4] = 3; 
