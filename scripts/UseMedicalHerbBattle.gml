...
case 0:
    ...
    global.CastEnd = 0;
    CreateBattleDialogueBasic(WordWrap(string(Attacker.Character.Name) +' uses the ' + 'Medical Herb' + '!^@ ',200,'#',false), self.id);
...
case 50:
    ...
    Damage = 10;//Get_Spell_Stats(Spell,SpellLevel,'Damage');
