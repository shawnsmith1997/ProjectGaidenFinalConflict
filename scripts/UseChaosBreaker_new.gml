...
//===================
case 0:
    CreateBattleDialogueBasic(WordWrap(string(Attacker.Character.Name) +' uses the ' + 'Chaos Breaker' + '!^@ ',200,'#',false), self.id);
...
if(Reciever.Character.Health <= 0){//if target is dead, append death message
        ...
        CreateBattleDialogueBasic(WordWrap('#'+string(Reciever.Character.Name)+ ' took ' + ' 18 Damage!',200,'#',false), self.id);
}        
    break; 
//=================
//Continue Cutscene
