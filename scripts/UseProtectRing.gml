...
case 0:
    global.CastEnd = 0;
    CreateBattleDialogueBasic(WordWrap(string(Attacker.Character.Name) +' casts ' + 'Defense level 1' + '!^@ ',200,'#',false), self.id);
...
case 50:
 ...
 //   
    ...
    State = 60;//Display Hit Message
        ...
        HighestZ = 25;
        EXP += Calculate_EXP(25,round(Reciever.Character.Defense*0.25),round(Reciever.Character.Defense*0.25),MinimumXP,false)//Z,D,M,Min,Bonus
        with(Reciever){
...
case 60:
    ...
    CreateBattleDialogueBasic(WordWrap(string(Reciever.Character.Name) + ' Defense increased by ' + string(round(Reciever.Character.Defense*0.25)) + '!',200,'#',false), self.id);
    Reciever.Character.DefenceBuff = 3;
