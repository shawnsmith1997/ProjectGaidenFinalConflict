...
if (Character.Level = 2 and global.Promoted[8] = 1){
Character.Spells[1] = 'Katon'; //Ruburan Learns Bolt
Character.SpellLevel[1] = 1; //Ruburan Learns Bolt Level 1
Message += string(' ^#Ruburan learned Katon');
}

if (Character.Level = 8 and global.Promoted[8] = 1){
Character.Spells[2] = 'Raijin'; //Ruburan Learns Bolt
Character.SpellLevel[2] = 1; //Ruburan Learns Bolt Level 1
Message += string(' ^#Ruburan learned Raijin');
}

if (Character.Level = 5 and global.Promoted[8] = 1){
Character.SpellLevel[1] = 2; //Ruburan Learns Blaze Level 3
Message += string(' ^#Katon is now Level 2');
}

if (Character.Level = 11 and global.Promoted[8] = 1){
Character.SpellLevel[1] = 3; //Ruburan Learns Blaze Level 3
Message += string(' ^#Katon is now Level 3');
}

if (Character.Level = 17 and global.Promoted[8] = 1){
Character.SpellLevel[1] = 4; //Ruburan Learns Blaze Level 4
Message += string(' ^#Katon is now Level 4');
}

if (Character.Level = 13 and global.Promoted[8] = 1){
Character.SpellLevel[2] = 2; //Ruburan Learns Bolt Level 2
Message += string(' ^#Raijin is now Level 2');
}

if (Character.Level = 15 and global.Promoted[8] = 1){
Character.SpellLevel[2] = 3; //Ruburan Learns Bolt Level 3
Message += string(' ^#Raijin is now Level 3');
}
if (Character.Level = 19 and global.Promoted[8] = 1){
Character.SpellLevel[2] = 4; //Ruburan Learns Bolt Level 4
