...
if(global.BattleState = 1){
    if(Character.SubID = 1){//Closest Wolf
        var Target;
            if (( Character.ID = 1032  or Character.ID = 1038 ) and Character.Magic > 10){
            Target = FindEnemyMagicTarget(Character, 1,2);
            Character.SpellCast = 1;
            Character.SpellCastLevel = 3;
            }        
            else if ((Character.ID = 1022 or Character.ID = 1021 or Character.ID = 1029  or Character.ID = 1032  or Character.ID = 1038 ) and Character.Magic > 5){
            Target = FindEnemyMagicTarget(Character, 1,2);
            Character.SpellCast = 1;
        ...
        var Target;
            ...
            if ( (Character.ID = 1022 or Character.ID = 1021 or Character.ID = 1029  or Character.ID = 1032  or Character.ID = 1038 ) and Character.Magic > 5){
            Target = FindEnemyMagicTarget(Character, 1,2);
            Character.SpellCast = 1;
            Character.SpellCastLevel = 2;
            }
    ...
    if((Character.SubID = 1)||(Character.SubID = 2)){
        ...
        var Target;
            ...
            else if ( (Character.ID = 1022 or Character.ID = 1021 or Character.ID = 1029  or Character.ID = 1032  or Character.ID = 1038 ) and Character.Magic > 2){
            Target = FindEnemyMagicTarget(Character, 1,2);
            Character.SpellCast = 1;
            Character.SpellCastLevel = 1;
            }
